...
### [Fingerprint Siamese-Seeded GAN](https://denkovarik.github.io/Fingerprint/Experiments/Fingerprint%20Siamese%20Neural%20Network%202%2020230308.html) (12/24/2025)

This iteration of the Fingerprint GAN leverages the frozen subnetwork from a previously trained Siamese Neural Network (version 1.0) to generate feature embeddings from unenhanced, low-quality fingerprint images. These embeddings serve as conditioning seeds for the GAN, guiding the generator to produce enhanced fingerprint outputs.

Prior versions employed an encoder-decoder architecture for the generator and a simple encoder for the discriminator, resulting in unstable training dynamics and suboptimal image quality. By incorporating the Siamese subnetwork's embeddings, this approach significantly improves training stability and yields superior generated images. Although the outputs do not yet preserve the original fingerprints' identifying features, they exhibit markedly enhanced visual quality compared to earlier iterations, representing a promising step toward realistic, identity-preserving enhancements.
